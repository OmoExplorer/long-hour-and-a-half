...
public class setupFramePre extends javax.swing.JFrame {
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        difficultyPanel.setBorder(BorderFactory.createTitledBorder("Сложность"));
        ...
        bladAtStartLabel.setText("Мочевой пузырь с начала игры");
        ...
        DefaultMutableTreeNode treeNode2 = new DefaultMutableTreeNode("Случайно");
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Женская");
        DefaultMutableTreeNode treeNode3 = new DefaultMutableTreeNode("Трусики");
        DefaultMutableTreeNode treeNode4 = new DefaultMutableTreeNode("Стринги");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Трусики \"Танга\"");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Обычные трусики");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Трусики с закрытыми бёдрами");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Купальники");
        treeNode4 = new DefaultMutableTreeNode("Бикини-стринги");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Обычные бикини");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Слитный купальник");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Подгузники");
        treeNode4 = new DefaultMutableTreeNode("Лёгкий подгузник");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Средний подгузник");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Большой подгузник");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Прокладки");
        treeNode4 = new DefaultMutableTreeNode("Лёгкая прокладка");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Обычная прокладка");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Большая прокладка");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Мужская");
        treeNode3 = new DefaultMutableTreeNode("Трусы");
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Трусы с закрытыми бёдрами");
        treeNode2.add(treeNode3);
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Специальная");
        treeNode3 = new DefaultMutableTreeNode("Анти-гравитационные трусы");
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Гипервпитывающий подгузник");
        treeNode2.add(treeNode3);
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Без нижней одежды");
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Пользовательская");
        treeNode1.add(treeNode2);
        ...
        treeNode2 = new DefaultMutableTreeNode("Случайно");
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Женская");
        treeNode3 = new DefaultMutableTreeNode("Джинсы");
        treeNode4 = new DefaultMutableTreeNode("Обычные джинсы");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Джинсы по колено");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Джинсовые шорты");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Джинсовые мини-шорты");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Брюки");
        treeNode4 = new DefaultMutableTreeNode("Обычные брюки");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Брюки по колено");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Шорты");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Мини-шорты");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Юбки");
        treeNode4 = new DefaultMutableTreeNode("Длинная юбка");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Обычная юбка");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Короткая юбка");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Мини-юбка");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Микро-юбка");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Длинная юбка с колготками");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Обычная юбка с колготками");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Короткая юбка с колготками");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Мини-юбка с колготками");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Микро-юбка с колготками");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Леггинсы");
        treeNode2.add(treeNode3);
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Мужская");
        treeNode3 = new DefaultMutableTreeNode("Джинсы");
        treeNode4 = new DefaultMutableTreeNode("Мужские джисовые шорты");
        treeNode3.add(treeNode4);
        treeNode4 = new DefaultMutableTreeNode("Мужские джинсы");
        treeNode3.add(treeNode4);
        treeNode2.add(treeNode3);
        treeNode3 = new DefaultMutableTreeNode("Мужские брюки");
        treeNode2.add(treeNode3);
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Без верхней одежды");
        treeNode1.add(treeNode2);
        treeNode2 = new DefaultMutableTreeNode("Пользовательская");
        treeNode1.add(treeNode2);
        ...
        wearEditorButton.setText("Редактор одежды");

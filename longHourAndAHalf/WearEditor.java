...
import static longHourAndAHalf.Wear.WearType.*;
...
//        fc.setFileSelectionMode(JFileChooser.FILES_ONLY);
    ...
    private void initComponents() {
        ...
        this.nameLabel.setText("Wear name");
        this.nameLabel.setToolTipText("Your wear name (e. g. \"Beautiful skirt\")");
        this.nameLabel.setName("nameLabel"); // NOI18N

        this.nameField.setToolTipText("Your wear name (e. g. \"Beautiful skirt\")");
        ...
        this.insertNameLabel.setText("Wear insert name");
        this.insertNameLabel.setToolTipText("Your wear name which is inserted in the game text (e. g. \"skirt\")");
        this.insertNameLabel.setName("insertNameLabel"); // NOI18N

        this.insertNameField.setToolTipText("Your wear name which is inserted in the game text (e. g. \"skirt\")");
    ...
    {//GEN-HEADEREND:event_saveButtonActionPerformed
        ...
        if (this.fc.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                this.wear = new Wear(this.nameField.getText(), this.insertNameField.getText(), (float) this.pressureSpinner.getValue(), (float) this.absorptionSpinner.getValue(), (float) this.dotSpinner.getValue());

 ...
 */
class PlotMap(@Suppress("KDocMissingDocumentation") @Transient var core: Core) {
    ...
    private val askTeacherToPee = when (core.schoolDay.lesson.timesPeeDenied) {
    ...
    private val holdCrotch = if (!core.character.cornered) action(
            when (core.character.gender) {
                FEMALE -> "Press on your crotch"
                MALE -> "Squeeze your dick"
            }
    ) {
        core.ui.forcedTextChange(Text("You don't think anyone will see you doing it,",
    ...
    private val rubThighs = action("Rub thighs") {
        core.ui.forcedTextChange(Text("You need to go, and it hurts, but you just",
    ...
    private val giveUp = if (core.character.bladder.fullness > 100) action("Give up") {
        core.ui.forcedTextChange(Text("You're absolutely desperate to pee, and you think you'll",
    ...
    private val drink = if (core.hardcore) action("Drink") {
        core.ui.forcedTextChange(Text("Feeling a tad bit thirsty,",
                "You decide to take a small sip of water from your bottle to get rid of it."))
        core.plot.nextStageID = PlotStageID.DRINK
    } else null

    private val cheat = action("Cheat (you'll lose your score)") {
        core.ui.forcedTextChange(Text("You've got to go so bad!",
    ...
    private val map = mapOf(
                            ...
                            listOf(
                                ...
                                FULLY_CLOTHED -> listOf(
                                        "You hurriedly slip on some " +
                                                "${core.character.undies.insert} and ${core.character.lower.insert},",
                            ...
                            when (core.character.wearCombinationType) {
                                ...
                                OUTERWEAR_ONLY ->
                                    if (core.character.lower.insert == "skirt"
                                        ...
                                        setOf(
                                                TextLine("Next time you run into class, ${core.character.name},", true),
                                                TextLine("your teacher says,"),
                                                TextLine("make sure you're wearing something less... revealing!"),
                                        ...
                                        setOf(
                                                TextLine("Sit down, ${core.character.name}. You're running late.",
                                                        true),
                                                TextLine("your teacher says,"),
            ...
            PlotStageID.ASK_TO_PEE_ANSWER to plotStageLambda(
                    run {
                        if (core.flags.peeingAllowed) {
                            ...
                            when (core.schoolDay.lesson.timesPeeDenied) {
                                0 -> Text(TextLine("No, you can't go out, the director prohibited it.", true),
            ...
            PlotStageID.ASK_CHEAT to plotStageLambda(
                    ...
                    actions = listOf(
                            ...
                            {
                                core.ui.forcedTextChange(Text(if (core.character.cornered)
                            ...
                            {
                                core.ui.forcedTextChange(Text(if (core.schoolDay.lesson.stay)
                            ...
                            {
                                core.ui.forcedTextChange(Text("A voice comes over the loudspeaker:",
                            ...
                            {
                                core.ui.forcedTextChange(Text("The teacher feels sorry for you. Try asking to pee."))
                            ...
                            {
                                core.ui.forcedTextChange(Text("You decide to raise your hand."))
                                core.plot.nextStageID = PlotStageID.CALLED_ON
                            },
                            action("Empty the bladder every 15 minutes")
                            {
                                core.ui.forcedTextChange(Text("Suddenly, you feel like you're peeing...",
                            ...
                            {
                                core.ui.forcedTextChange(Text("A friend in the desk next to you hands you a familiar",
                                ...
                                core.character.bladder.maxSphincterPower = (100 / core.character.bladder.incontinence)
                                        .toInt()
                                core.character.bladder.sphincterPower = core.character.bladder.maxSphincterPower
                            },
                            action("Toggle hardcore mode")
                            {
                                core.ui.forcedTextChange(Text("The teacher suddenly looks like they've had enough",
                                        "of people having to pee."))
                                core.hardcore = !core.hardcore
                            },
                            action("Change the bladder fullness")
                            {
                                core.ui.forcedTextChange(Text("Suddenly you felt something going on in your bladder."))
                                core.character.bladder.incontinence =
                    ...
                    Text(
                            when (core.character.wearCombinationType) {
                                FULLY_CLOTHED -> listOf("Before you can move an inch, pee quickly soaks through your " +
                                        ...
                                        "floods your " + core.character.lower.insert + ", and streaks down your legs.")
                                ...
                                NAKED -> if (!core.character.cornered) {
                                    listOf("The heavy pee jets are hitting the seat and loudly leaking out from your " +
                                            core.character.undies.insert + ".",
                    ...
                    Text(
                            listOf(
                                    ...
                                    when (core.character.wearCombinationType) {
                                        ...
                                        OUTERWEAR_ONLY -> "Your ${core.character.lower.insert} clings to your skin, " +
                                                "a sign of your failure..."
                                        UNDERWEAR_ONLY -> "Your ${core.character.undies.insert} clings to your skin, " +
                                                "a sign of your failure..."
            ...
            PlotStageID.CAUGHT to plotStageLambda(
                    ...
                    PlotStageID.ASK_ACTION,
                    scoreNomination = ScoreNomination("Caught holding pee", when (core.schoolDay.timesCaught) {
                        0 -> 3
                        1 -> 8
                        2 -> 12
                        else -> 20
                                    ...
                                    if (chance(
                                            when (core.schoolDay.surpriseBoy.timesPeeDenied) {
                                                ...
                                                2 -> 2
                                                    ...
                                                    throw IllegalStateException("character asked to pee after 3 fails")
                                            }
                                    )) PlotStageID.PERSUADE else PlotStageID.PERSUADE_FAILED
                            ),
                            action("Hit him")
                            {
                                core.plot.nextStageID = if (chance(20)) PlotStageID.HIT else PlotStageID.HIT_FAILED
                            },
            ...
            PlotStageID.PERSUADE to plotStageLambda(
                    Text(
                            setOf(
                                    ...
                                    when (core.character.wearCombinationType) {
                                        FULLY_CLOTHED -> TextLine("pull down your ${core.character.lower.insert}" +
                                                " and ${core.character.undies.insert},")
                                        OUTERWEAR_ONLY ->

...
public class ALongHourAndAHalf extends JFrame
{
    ...
    Wear[] underwearList
            =
            {
                ...
                new Wear("Лёгкий подгузник", "подгузник", "подгузник", 9, 50, 0, (byte)1),
                new Wear("Средний подгузник", "подгузник", "подгузник", 18, 100, 0, (byte)1),
                new Wear("Большой подгузник", "подгузник", "подгузник", 25, 175, 0, (byte)1),
                new Wear("Лёгкая прокладка", "прокладка", "прокладку", 2, 16, 0.25F, (byte)1),
                new Wear("Обычная прокладка", "прокладка", "прокладку", 3, 24, 0.25F, (byte)1),
                new Wear("Большая прокладка", "прокладка", "прокладку", 4, 32, 0.25F, (byte)1),
...
//        fc.setFileSelectionMode(JFileChooser.FILES_ONLY);
        ...
        if (isMale())
        {
            undies.setInsertName("член");
        }
        else
        {
            lower.setInsertName("промежность");
        }

...
import static omo.ALongHourAndAHalf.Location.*;
...
public class ALongHourAndAHalf extends JFrame
{
    ...
    /**
     * List of all cheats on street.
     */
    String[] cheatListStreet
            =
            {
                "Pee in a bottle", "Make your pee disappear regularly",
                "Set your incontinence level", "Toggle hardcore mode", "Set bladder fulness"
            };
...
//                } while (listChoice.isSelectionEmpty());
            ...
            case ASK_CHEAT_STREET:
//                do
//                {
                listChoice.setListData(cheatListStreet);
                showActionUI("Select a cheat:");
                nextStage = CHOSE_CHEAT_STREET;
//                } while (listChoice.isSelectionEmpty());
                break;

            case CHOSE_CHEAT_STREET:
                if (listChoice.isSelectionEmpty())
                {
                ...
                switch (hideActionUI())
                {
                    ...
                    case 2:
                        setText("You've found a familiar",
                                "looking pill, and you take it.");
                        incon = Float.parseFloat(JOptionPane.showInputDialog("How incontinent are you now?"));
                        maxSphincterPower = (short) (100 / incon);
                        sphincterPower = maxSphincterPower;
            ...
            case POST_WET:
                switch (currentLocation)
                {
                    ...
                    case STREET:
                        if (!lower.isMissing())
                        {
                            setText("Passersby are looking at your soaked " + lower.insert() + " with a confusion.");
                        }
                        else if (!undies.isMissing())
                        {
                            setText("Passersby are looking at your soaked " + undies.insert() + " with a confusion.");
                        }
                        else
                        {
                            setText("Passersby are looking at you with a confusion.");
                        }
                        break;
                    case BUS:
                        if (!lower.isMissing())
                        {
                            setText("Passengers are looking at your soaked " + lower.insert() + " with a confusion.");
                        }
                        else if (!undies.isMissing())
                        {
                            setText("Passengers are looking at your soaked " + undies.insert() + " with a confusion.");
                        }
                        else
                        {
                            setText("Passengers are looking at you with a confusion.");
                        }
                        break;
                }
                ...
                setText((bladder < 80) ? "You came to the mall without any problems." : "You finally made it to the mall. Ah, that was the hard road...",
                        ...
                        publicRestroomFound
                                ...
                                : allowedToUseEmployeeRestroom
                                        ? "<i>Can I use this restroom, please?<br>Yes, you can.</i>"
                                        : "<i>Can I use this restroom, please?<br>Sorry, I can't let you in. This restroom is for employees only.</i>",
                ...
                switch (hideActionUI())
                {
                    ...
                    case 2:
                        setText("You're absolutely desperate to pee, and you think you'll",
                                "end up peeing yourself anyway, so it's probably best to admit",
                                "defeat and get rid of the painful ache in your bladder.");
                        nextStage = GIVE_UP; //TODO: Make extended game support
                        break;
                    ...
                    case 3:
                        setText("Feeling a tad bit thirsty,",
                                "You decide to take a small sip of water from your bottle to get rid of it.");
                        nextStage = DRINK; //TODO: Make extended game support
                        break;
...
//                    setText("You spent a few minutes doing nothing.");
            ...
            case BACK_TO_SCHOOL_ASK_ACTION: //TODO: Implement holding system here
                ...
                actionList.add("Cheat (will reset your score)");
                updateChoiceList();
                nextStage = BACK_TO_SCHOOL_CHOSE_ACTION;
                break;
...
//                    setText("You spent a few minutes doing nothing.");
            ...
            case GOING_TO_HOME_ASK_ACTION: //TODO: Implement holding system here
                ...
                if (walkTime > 0)
                {
                    ...
                    actionList.add("Cheat (will reset your score)");
                    updateChoiceList();
                    nextStage = GOING_TO_HOME_CHOSE_ACTION;
                }
                else
                {
...
//                writer = new PrintStream(file);
    ...
    enum GameStage
    {
        ...
        ASK_CHEAT_STREET, //Street/bus, waiting for player to select a cheat 
        CHOSE_CHEAT, //TODO: Rework
        CHOSE_CHEAT_STREET, //TODO: Rework
